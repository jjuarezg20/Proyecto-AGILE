...
INSERT INTO Empleado (nombre, cargo, id_estado, createdate) VALUES 
('Juan Pérez', 'admin', 1, CURRENT_TIMESTAMP), 
('Ana Gómez', 'vendedor', 1, CURRENT_TIMESTAMP), 
('Carlos Ruiz', 'vendedor', 2, CURRENT_TIMESTAMP);
